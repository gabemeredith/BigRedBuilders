# CLAUDE.md — Ivy Builder Rankings 
...
## Project Summary
A polished, funny, shareable web app where users vote on who's more cracked across the Ivy League. Social game, not a serious ranking. Feel: Ivy-native, internet-native, slightly absurd, not mean-spirited.
...
- **Do not clone other sites** — preserve the social ranking mechanic, adapt to Ivy League culture, improve the taste.
...
4. **Leaderboard** — dramatic, screenshot-worthy, filterable by school
...
## Copywriting
Witty, concise, internet-native, self-aware, playful. Examples: *"Who's more cracked?" / "Settle the Ivy League hierarchy." / "Vote responsibly."*
...
## Data / Profiles
Focus on: name, Ivy League affiliation, experience, role titles, optional headline + tags (SWE, Quant, Startup, AI, Research, Systems, Product, Builder).
...
**Final goal:** A Ivy League student sees it once and immediately sends it to 5 friends.
